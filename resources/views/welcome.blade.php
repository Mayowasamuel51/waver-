...
@php
    ...
    $tickets= DB::table('tickets')->orderBy('state', 'Asc')->get();
...
@endphp
        ...
        <section class="banner-area relative" id="home">
            ...
            <div class="container">
               ...
               @endif
                        <form class="form" method="POST" action="{{ route('new.bookings') }}">
                             @csrf
                        ...
                        <input class="form-control txt-field @error('fullname') is-invalid @enderror" type="text" name="fullname" placeholder="Your name"  onfocus="this.placeholder = ''" onblur="this.placeholder = 'Your name'" value="{{ old('fullname')}}">
                        ...
                        <input class="form-control txt-field @error('email') is-invalid @enderror" type="email" name="email" value="{{ old('email')}}"placeholder="Email address" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Email address'">


                         @error('phone')
                                 <div class="text-danger font-weight-bold">{{ $message}}</div>
                            @enderror
                         <input class="form-control txt-field @error('phone') is-invalid @enderror" type="tel" name="phone" placeholder="Phone number" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Phone number'"  value="{{ old('phone')}}">
                            </div>	

                        <input class="form-control txt-field"type="text" name="fromDestination" placeholder="FROM  Destination" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Phone number'"  value="">
                            </div>  


                         {{-- error('fromDestination')
                                 <div class="text-danger font-weight-bold">{{ $message}}</div>
                            @enderror --}}
                          ...
                          {{--   <div class="form-group">
                                <div class="default-select" id="default-select">
                                    <select name="fromDestination">
                                        <option value="lagos" disabled selected hidden name="fromDestination">From Destination</option>
                         ...
                         @error('toDestination')
                            ...
                            <div class="form-group">
                                <div class="input-group dates-wrap">                                              
                                    <input id="datepicker2" class="dates form-control"    name="date"  placeholder="Date & time" type="text">                        
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-4 single-gallery">
                        <a href="img/g1.jpg" class="img-gal"><img class="img-fluid" src="{{ asset('front/img/g1.jpg') }}" alt=""></a>
                        <a href="img/g4.jpg" class="img-gal"><img class="img-fluid" src="{{ asset('front/img/g4.jpg') }}" alt=""></a>
                    </div>	
                    <div class="col-lg-4 single-gallery">
                        <a href="img/g2.jpg" class="img-gal"><img class="img-fluid" src="{{ asset('front/img/g2.jpg') }}" alt=""></a>
                        <a href="img/g5.jpg" class="img-gal"><img class="img-fluid" src="{{ asset('front/img/g5.jpg') }}" alt=""></a>						
                    </div>	
                    <div class="col-lg-4 single-gallery">
                        <a href="img/g3.jpg" class="img-gal"><img class="img-fluid" src="{{ asset('front/img/g3.jpg') }}" alt=""></a>
                        <a href="img/g6.jpg" class="img-gal"><img class="img-fluid" src="{{ asset('front/img/g6.jpg') }}" alt=""></a>
                    </div>				
                </div>
            </div>	
        </section>
