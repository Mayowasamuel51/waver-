//assignment to show the new booking from taxi to dashboard 
    ...
    <div class="page-wrapper">
        ...
        <div class="page-header navbar navbar-fixed-top">
            <div class="page-header-inner ">
                ...
                <div class="page-logo">
                    <a href="index.html">
                    <img alt="" src="{{ asset('admin/source/assets/img/logo.png') }}">
                ...
                <div class="top-menu">
                    <ul class="nav navbar-nav pull-right">
                        ...
                        <li class="dropdown language-switch">
                            <a class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false"> <img src="{{ asset('admin/source/assets/img/flags/gb.png') }}" class="position-left" alt=""> English <span class="fa fa-angle-down"></span>
                            </a>
                            <ul class="dropdown-menu animated tada">
                                <li>
                                    <a class="deutsch"><img src="{{ asset('admin/source/assets/img/flags/de.png') }}" alt=""> Deutsch</a>
                                </li>
                                <li>
                                    <a class="ukrainian"><img src="{{ asset('admin/source/assets/img/flags/ua.png') }}" alt=""> Українська</a>
                                </li>
                                <li>
                                    <a class="english"><img src="{{ asset('admin/source/assets/img/flags/gb.png') }}" alt=""> English</a>
                                </li>
                                <li>
                                    <a class="espana"><img src="{{ asset('admin/source/assets/img/flags/es.png') }}" alt=""> España</a>
                                </li>
                                <li>
                                    <a class="russian"><img src="{{ asset('admin/source/assets/img/flags/ru.png') }}" alt=""> Русский</a>
                                </li>
                            </ul>
                        </li>
                        <!-- end language menu -->
                                ...
                                <li>
                                    <ul class="dropdown-menu-list small-slimscroll-style" data-handle-color="#637283">
                                        <li>
                                            <a href="#">
                                                <span class="photo">
                                                	<img src="{{ asset('admin/source/assets/img/user/user2.jpg') }}" class="img-circle" alt=""> </span>
                                                <span class="subject">
                                        ...
                                        <li>
                                            <a href="#">
                                                <span class="photo">
                                                	<img src="{{ asset('admin/source/assets/img/user/user3.jpg') }}" class="img-circle" alt=""> </span>
                                                <span class="subject">
                                        ...
                                        <li>
                                            <a href="#">
                                                <span class="photo">
                                                	<img src="{{ asset('admin/source/assets/img/user/user1.jpg') }}" class="img-circle" alt=""> </span>
                                                <span class="subject">
                                        ...
                                        <li>
                                            <a href="#">
                                                <span class="photo">
                                                	<img src="{{ asset('admin/source/assets/img/user/user8.jpg') }}" class="img-circle" alt=""> </span>
                                                <span class="subject">
                                        ...
                                        <li>
                                            <a href="#">
                                                <span class="photo">
                                                	<img src="{{ asset('admin/source/assets/img/user/user5.jpg') }}" class="img-circle" alt=""> </span>
                                                <span class="subject">
                        ...
                        <!-- end message dropdown -->
 						...
 						<li class="dropdown dropdown-user">
                            <a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-close-others="true">
                                <img alt="" class="img-circle " src="{{ asset('admin/source/assets/img/dp.jpg') }}" />
	                    ...
	                    <ul class="sidemenu  page-header-fixed" data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200" style="padding-top: 20px">
	                        ...
	                        <li class="sidebar-user-panel">
	                            <div class="user-panel">
	                                <div class="pull-left image">
	                                    <img src="{{ asset('admin/source/assets/img/dp.jpg') }}" class="img-circle user-img-circle" alt="User Image" />
	                                </div>
							...
							<li class="nav-item">
	                            <a href="#" class="nav-link nav-toggle">
	                                ...
	                                <span class="title">Manage Ticket Fares</span>
	                                <span class="arrow">
	                            </a>
	                            <ul class="sub-menu">
	                                <li class="nav-item">
	                                    {{-- <a href="{{ route('all.task')}}" class="nav-link "> --}}
	                                        <span class="title">All Ticket Fares</span>
	                                    </a>
	                                </li>
	                                <li class="nav-item">
	                                    {{-- <a href="{{ route('create.ticket.fare') }}" class="nav-link "> --}}
	                                        <span class="title">Add Ticket Fares</span>
	                                    </a>
	                                </li>

                                     <li class="nav-item">
                                        {{-- <a href="{{ route('create.ticket.fare') }}" class="nav-link "> --}}
                                            <span class="title">Add Ticket</span>
                                        </a>
                                    </li>
                        	...
                        	<div class="chat-sidebar-list">
	                            <div class="chat-sidebar-chat-users slimscroll-style" data-rail-color="#ddd" data-wrapper-class="chat-sidebar-list">
	                                ...
	                                <ul class="media-list list-items">
	                                    <li class="media"><img class="media-object" src="{{ asset('admin/source/assets/img/user/user3.jpg') }}" width="35" height="35" alt="...">
	                                    ...
	                                    <li class="media">
	                                        ...
	                                        </div> <img class="media-object" src="{{ asset('admin/source/assets/img/user/user1.jpg') }}" width="35" height="35" alt="...">
	                                        <i class="busy dot"></i>
	                                        <div class="media-body">
	                                    ...
	                                    <li class="media"><img class="media-object" src="{{ asset('admin/source/assets/img/user/user5.jpg') }}" width="35" height="35" alt="...">
	                                        <i class="away dot"></i>
	                                        <div class="media-body">
	                                    ...
	                                    <li class="media">
	                                        ...
	                                        </div> <img class="media-object" src="{{ asset('admin/source/assets/img/user/user4.jpg') }}" width="35" height="35" alt="...">
	                                        <i class="online dot"></i>
	                                        <div class="media-body">
	                                    ...
	                                    <li class="media"><img class="media-object" src="{{ asset('admin/source/assets/img/user/user2.jpg') }}" width="35" height="35" alt="...">
	                                        <i class="busy dot"></i>
	                                        <div class="media-body">
	                                    ...
	                                    <li class="media"><img class="media-object" src="{{ asset('admin/source/assets/img/user/user7.jpg') }}" width="35" height="35" alt="...">
	                                        <i class="online dot"></i>
	                                        <div class="media-body">
	                                ...
	                                <ul class="media-list list-items">
	                                    <li class="media">
	                                        ...
	                                        </div> <img class="media-object" src="{{ asset('admin/source/assets/img/user/user6.jpg') }}" width="35" height="35" alt="...">
	                                    ...
	                                    <li class="media"><img class="media-object" src="{{ asset('admin/source/assets/img/user/user8.jpg') }}" width="35" height="35" alt="...">
	                                        <i class="offline dot"></i>
	                                        <div class="media-body">
	                                    ...
	                                    <li class="media">
	                                        ...
	                                        </div> <img class="media-object" src="{{ asset('admin/source/assets/img/user/user9.jpg') }}" width="35" height="35" alt="...">
	                                        <i class="offline dot"></i>
	                                        <div class="media-body">
	                                    ...
	                                    <li class="media"><img class="media-object" src="{{ asset('admin/source/assets/img/user/user10.jpg') }}" width="35" height="35" alt="...">
	                                        <i class="offline dot"></i>
	                                        <div class="media-body">
                            ...
                            <div class="chat-sidebar-item">
                                <div class="chat-sidebar-chat-user">
                                    ...
                                    <div class="chat-sidebar-chat-user-messages">
                                        <div class="post out">
                                            <img class="avatar" alt="" src="{{ asset('admin/source/assets/img/dp.jpg') }}" />
                                            <div class="message">
                                        ...
                                        <div class="post in">
                                            <img class="avatar" alt="" src="{{ asset('admin/source/assets/img/user/user5.jpg') }}" />
                                            <div class="message">
